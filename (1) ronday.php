...
<body>
    ...
    <div class="projectcontainer">
        <p class="name">Ronday Technologies</p>
    </div>
    ...
    <div class="projectcontainer">
        <div class="projectsidebyside">
            <div class="left">
                <p class="pgrey">
                    <b>Summary:</b> For my first design job, I worked at the tech startup Ronday Technologies on their
                    online 3D conferencing and hangout platform. As to be expected of startup work, I performed a myriad
                    of tasks both design-related and otherwise.
                    <br><br>
                    <b>Skills: </b>UX Design, UX Copy, User Research, Competitive Analysis, Graphic Design, Video
                    Directing, Video Recording, & Video Editing
                    <br><br>
                    <b>Time spent: </b>7 months.
                </p>
            </div>
